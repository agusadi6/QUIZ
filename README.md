...
<div class="container">
    ...
    <div id="quiz-area" style="display:none;">
        ...
        <button onclick="calculateScore()">Show My Score! 🏆</button>
    </div>
...
<script>
    ...
    function startQuiz() {
        ...
        if (name.trim() === "") return alert("Please type your name first! 😊");
    ...
    function calculateScore() {
        ...
        if (answeredCount < 5) {
            alert("Oops! Please answer all questions before finishing! 📝");
            return;
        }
        ...
        let feedback = finalScore === 100 ? "PERFECT! You are a superstar! ⭐" : "Well done! Keep practicing! 📖";
